...
const serviceAreas = [
  {
    name: 'Boise',
    href: '/boise',
    description: 'Idaho\'s capital city. Professional furniture removal services in Downtown, North End, Bench, and all Boise neighborhoods.',
  },
  {
    name: 'Meridian',
    href: '/meridian',
  ...
  },
  {
    name: 'Nampa',
    href: '/nampa',
    description: 'Canyon County\'s largest city. Furniture removal services throughout Nampa and surrounding areas.',
  },
  {
    name: 'Caldwell',
    href: '/caldwell',
  ...
  },
  {
    name: 'Eagle',
    href: '/eagle',
    description: 'Furniture removal services in Eagle, including estates and large properties.',
  },
]
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto">
            We provide professional furniture removal services throughout the Treasure Valley. Click on your city to learn more.
          </p>
        </div>
