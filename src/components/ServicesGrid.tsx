...
import { Sofa, Bed, Table, Armchair } from 'lucide-react'
import { useQuoteForm } from '@/context/QuoteFormContext'

const services = [
  {
    icon: Sofa,
    title: 'Couch & Sofa Removal',
    description: 'We haul away old couches, sofas, sectionals, and loveseats. No matter the size or weight, we handle the heavy lifting.',
  },
  {
    icon: Bed,
    title: 'Mattress & Bed Removal',
    description: 'Old mattresses, box springs, bed frames, and headboards. We remove them all and dispose of them properly.',
  },
  {
    icon: Table,
    title: 'Table & Desk Removal',
    description: 'Dining tables, coffee tables, desks, and entertainment centers. We carefully remove and haul them away.',
  },
  {
    icon: Armchair,
    title: 'Chair & Recliner Removal',
    description: 'Recliners, office chairs, dining chairs, and armchairs. Any type of seating we can remove for you.',
  },
]
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Professional furniture removal and hauling services for the Treasure Valley
          </p>
        </div>
