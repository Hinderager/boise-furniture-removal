...
const SITE_NAME = 'Boise Furniture Removal'
const SITE_URL = 'https://boise-furniture-removal.com'
const SITE_PHONE = '+1-208-943-5231'
const SERVICE_NAME = 'Furniture Removal Services'
    ...
    image: [
      {
        ...
        name: 'Furniture Removal Services in the Treasure Valley',
        caption: 'Boise Furniture Removal crew at work in Meridian, Idaho',
        contentLocation: {
          '@type': 'Place',
          name: 'Meridian, Idaho',
          geo: { '@type': 'GeoCoordinates', latitude: 43.6218, longitude: -116.3979 },
        },
      },
    ],
    aggregateRating: {
