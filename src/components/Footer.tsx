      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-white/80">Couch Removal</li>
              <li className="text-white/80">Mattress Removal</li>
              <li className="text-white/80">Table & Chair Removal</li>
              <li className="text-white/80">Dresser Removal</li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <a
                    href="mailto:info@boise-furniture-removal.com"
                    className="text-white/80 hover:text-white transition-colors"
                  >
                    info@boise-furniture-removal.com
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-center md:text-right">
              <p className="text-white/60 text-sm">
                &copy; {new Date().getFullYear()} Boise Furniture Removal. All rights reserved.
              </p>
