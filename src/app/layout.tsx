...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'couch removal Meridian',
    'sofa removal Nampa',
    'furniture hauling near me',
    'table removal Caldwell',
    'dresser removal Eagle Idaho',
    'furniture disposal Treasure Valley',
    'bulky furniture pickup',
    'furniture junk removal Idaho',
  ...
  alternates: {
    canonical: 'https://boise-furniture-removal.com',
  },
}
