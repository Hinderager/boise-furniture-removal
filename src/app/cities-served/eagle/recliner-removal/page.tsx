...
export const metadata: Metadata = {
  title: 'Recliner & Chair Removal Eagle ID | Top Shelf Furniture Removal',
  description: 'Recliners, armchairs, and oversized furniture removal. We handle power recliners too. in Eagle, Idaho. Same-day service. Licensed & insured. Call (208) 943-5231.',
  keywords: ['recliner-removal Eagle', 'furniture removal Eagle', 'junk removal Eagle'],
  alternates: {
    canonical: 'https://boise-furniture-removal.com/cities-served/eagle/recliner-removal',
  },
}
...
export default function EagleReclinerRemovalPage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/recliner-removal.webp"
          alt="Recliner & Chair Removal in Eagle, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Recliner & Chair Removal in Eagle</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Recliners, armchairs, and oversized furniture removal. We handle power recliners too. Serving Eagle and the Treasure Valley.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Recliner & Chair Removal Services in Eagle</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Need recliner removal in Eagle? We make it easy. You point, we haul. No heavy lifting for you.</p>
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Recliner & Chair Removal in Eagle?</h3>
