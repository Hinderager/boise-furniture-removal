...
export const metadata: Metadata = {
  ...
  description: 'Recliners, armchairs, and oversized furniture removal. We handle power recliners too. in Eagle, Idaho. Same-day service. Licensed & insured. Call (208) 505-9352.',
