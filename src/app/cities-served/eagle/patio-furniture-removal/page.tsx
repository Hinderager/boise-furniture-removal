...
export const metadata: Metadata = {
  title: 'Patio & Outdoor Furniture Removal Eagle ID | Top Shelf Furniture Removal',
  description: 'Outdoor furniture removal including patio sets, grills, and yard furniture. in Eagle, Idaho. Same-day service. Licensed & insured. Call (208) 505-9352.',
  keywords: ['patio-furniture-removal Eagle', 'furniture removal Eagle', 'junk removal Eagle'],
  alternates: {
    canonical: 'https://boise-furniture-removal.com/cities-served/eagle/patio-furniture-removal',
  },
}
...
export default function EaglePatioFurnitureRemovalPage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/patio-furniture-removal.webp"
          alt="Patio & Outdoor Furniture Removal in Eagle, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Patio & Outdoor Furniture Removal in Eagle</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Outdoor furniture removal including patio sets, grills, and yard furniture. Serving Eagle and the Treasure Valley.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Patio & Outdoor Furniture Removal Services in Eagle</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Need patio furniture removal in Eagle? We make it easy. You point, we haul. No heavy lifting for you.</p>
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Patio & Outdoor Furniture Removal in Eagle?</h3>
