...
export const metadata: Metadata = {
  title: 'Mattress Removal Eagle ID | Boise Furniture Removal',
  description: 'Fast, affordable mattress and box spring removal. We recycle when possible. in Eagle, Idaho. Same-day service. Licensed & insured. Call (208) 943-5231.',
