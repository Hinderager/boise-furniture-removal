...
export const metadata: Metadata = {
  ...
  description: 'Professional couch and sofa removal services. We handle all types of couches, sectionals, and loveseats. in Nampa, Idaho. Same-day service. Licensed & insured. Call (208) 505-9352.',
