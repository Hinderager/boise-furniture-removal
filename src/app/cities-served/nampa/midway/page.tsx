...
export const metadata: Metadata = {
  title: 'Furniture Removal Midway Nampa | Boise Furniture Removal',
  description: 'Furniture Removal services in Midway, Nampa, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['furniture removal Midway', 'furniture removal Midway Nampa', 'Midway nampa furniture removal'],
  alternates: {
    canonical: 'https://boise-furniture-removal.com/cities-served/nampa/midway',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Furniture Removal in Midway
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Midway residents trust us for furniture removal. Here's why.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Furniture Removal in Midway, Nampa
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Furniture removal from Midway homes. Old stuff out, new space in.</p>
                <p>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            Back to Nampa Furniture Removal
          </Link>
        </div>
      </section>
    </main>
