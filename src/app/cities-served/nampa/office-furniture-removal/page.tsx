...
export const metadata: Metadata = {
  ...
  description: 'Commercial and home office furniture removal. Desks, filing cabinets, cubicles, and more. in Nampa, Idaho. Same-day service. Licensed & insured. Call (208) 505-9352.',
  keywords: ['office-furniture-removal Nampa', 'furniture removal Nampa', 'junk removal Nampa'],
  alternates: {
    canonical: 'https://boise-furniture-removal.com/cities-served/nampa/office-furniture-removal',
  },
}
...
export default function NampaOfficeFurnitureRemovalPage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/office-furniture-removal.webp"
          alt="Office Furniture Removal in Nampa, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Office Furniture Removal in Nampa</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Commercial and home office furniture removal. Desks, filing cabinets, cubicles, and more. Serving Nampa and the Treasure Valley.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Office Furniture Removal in Nampa?</h3>
