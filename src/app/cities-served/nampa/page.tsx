...
export const metadata: Metadata = {
  ...
  description: 'Professional furniture removal services in Nampa, Idaho. Couches, mattresses, office furniture & more. Same-day service available. Call (208) 505-9352.',
