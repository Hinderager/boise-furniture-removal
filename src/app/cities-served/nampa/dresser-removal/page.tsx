...
export const metadata: Metadata = {
  ...
  description: 'Complete bedroom furniture removal including dressers, nightstands, and armoires. in Nampa, Idaho. Same-day service. Licensed & insured. Call (208) 943-5231.',
