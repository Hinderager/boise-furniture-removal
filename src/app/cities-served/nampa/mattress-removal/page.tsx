...
export const metadata: Metadata = {
  ...
  description: 'Fast, affordable mattress and box spring removal. We recycle when possible. in Nampa, Idaho. Same-day service. Licensed & insured. Call (208) 505-9352.',
