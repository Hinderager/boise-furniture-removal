...
export const metadata: Metadata = {
  title: 'Furniture Removal Southeast Boise Boise | Boise Furniture Removal',
  description: 'Furniture Removal services in Southeast Boise, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['furniture removal Southeast Boise', 'furniture removal Southeast Boise Boise', 'Southeast Boise boise furniture removal'],
  alternates: {
    canonical: 'https://boise-furniture-removal.com/cities-served/boise/southeast-boise',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Furniture Removal in Southeast Boise
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Southeast Boise residents trust us for furniture removal. Here's why.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Furniture Removal in Southeast Boise, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Old furniture cluttering your Southeast Boise home? We remove it all, from basement finds to patio furniture that's seen better days.</p>
                <p>
