...
export const metadata: Metadata = {
  ...
  description: 'Dining tables, chairs, and kitchen furniture removal. Any size, any condition. in Boise, Idaho. Same-day service. Licensed & insured. Call (208) 505-9352.',
  keywords: ['table-removal Boise', 'furniture removal Boise', 'junk removal Boise'],
  alternates: {
    canonical: 'https://boise-furniture-removal.com/cities-served/boise/table-removal',
  },
}
...
export default function BoiseTableRemovalPage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/table-removal.webp"
          alt="Table & Dining Furniture Removal in Boise, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Table & Dining Furniture Removal in Boise</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Dining tables, chairs, and kitchen furniture removal. Any size, any condition. Serving Boise and the Treasure Valley.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Table & Dining Furniture Removal in Boise?</h3>
