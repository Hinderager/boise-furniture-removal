...
export const metadata: Metadata = {
  title: 'Furniture Removal The Bench Boise | Boise Furniture Removal',
  description: 'Furniture Removal services in The Bench, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['furniture removal The Bench', 'furniture removal The Bench Boise', 'The Bench boise furniture removal'],
  alternates: {
    canonical: 'https://boise-furniture-removal.com/cities-served/boise/bench',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Furniture Removal in The Bench
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Looking for furniture removal in The Bench? You've found the right team.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Furniture Removal in The Bench, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Couches, mattresses, dressers, entertainment centers - we remove it all from Bench homes. Our team handles the heavy lifting while you focus on what's next.</p>
                <p>
