...
export const metadata: Metadata = {
  title: 'Furniture Removal West Boise Boise | Boise Furniture Removal',
  description: 'Furniture Removal services in West Boise, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['furniture removal West Boise', 'furniture removal West Boise Boise', 'West Boise boise furniture removal'],
  alternates: {
    canonical: 'https://boise-furniture-removal.com/cities-served/boise/west-boise',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Furniture Removal in West Boise
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Need furniture removal services in the West Boise area? We can help.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Furniture Removal in West Boise, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>West Boise furniture removal is what we do. Couches, beds, desks, outdoor sets - if it's too big for your trash, we'll take it.</p>
                <p>
