...
export const metadata: Metadata = {
  title: 'Furniture Removal North End Boise | Top Shelf',
  ...
  alternates: {
    canonical: 'https://boise-furniture-removal.com/cities-served/boise/north-end',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Furniture Removal in North End
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Need furniture removal services in the North End area? We can help.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Furniture Removal in North End, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Whether it's a vintage piece that's seen better days or modern furniture that no longer fits your North End cottage, we'll haul it away. Many items get donated to local charities rather than going to the landfill.</p>
                <p>
