...
export const metadata: Metadata = {
  title: 'Furniture Removal Star ID | Top Shelf Furniture Removal',
  description: 'Professional furniture removal services in Star, Idaho. Couches, mattresses, office furniture & more. Same-day service available. Call (208) 943-5231.',
  keywords: ['furniture removal Star', 'junk removal Star', 'couch removal Star'],
  alternates: {
    canonical: 'https://boise-furniture-removal.com/cities-served/star',
  },
}

const services = [
  { name: 'Couch Removal', href: '/cities-served/star/couch-removal' },
  { name: 'Mattress Removal', href: '/cities-served/star/mattress-removal' },
  { name: 'Dresser Removal', href: '/cities-served/star/dresser-removal' },
  { name: 'Table Removal', href: '/cities-served/star/table-removal' },
  { name: 'Office Furniture', href: '/cities-served/star/office-furniture-removal' },
  { name: 'Recliner Removal', href: '/cities-served/star/recliner-removal' },
  { name: 'Entertainment Center', href: '/cities-served/star/entertainment-center-removal' },
  { name: 'Patio Furniture', href: '/cities-served/star/patio-furniture-removal' },
]

export default function StarFurniturePage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/furniture-removal-hero.webp"
          alt="Furniture Removal in Star, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Furniture Removal in Star</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Professional furniture removal services in Star. We handle couches, mattresses, office furniture, and more. Fast, affordable, reliable.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Furniture Removal Services in Star</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              ...
              <p>Top Shelf Furniture Removal serves Star and the entire Treasure Valley. We show up on time, work fast, and leave your space clean. No hidden fees, no hassle.</p>
            </div>

            <h3 className="text-2xl font-bold text-dark-blue mb-6">What We Remove in Star</h3>
            ...
            <ul className="space-y-4 mb-12">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-700"><strong>Local Star Team:</strong> We know the area and respond fast to service calls.</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              ...
              <p className="text-gray-300 mb-6">Call now for a free quote and same-day service in Star.</p>
