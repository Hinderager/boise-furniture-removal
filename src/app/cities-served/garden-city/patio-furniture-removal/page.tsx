...
export const metadata: Metadata = {
  title: 'Patio & Outdoor Furniture Removal Garden City ID | Top Shelf Furniture Removal',
  description: 'Outdoor furniture removal including patio sets, grills, and yard furniture. in Garden City, Idaho. Same-day service. Licensed & insured. Call (208) 943-5231.',
  keywords: ['patio-furniture-removal Garden City', 'furniture removal Garden City', 'junk removal Garden City'],
  alternates: {
    canonical: 'https://boise-furniture-removal.com/cities-served/garden-city/patio-furniture-removal',
  },
}
...
export default function GardenCityPatioFurnitureRemovalPage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/patio-furniture-removal.webp"
          alt="Patio & Outdoor Furniture Removal in Garden City, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Patio & Outdoor Furniture Removal in Garden City</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Outdoor furniture removal including patio sets, grills, and yard furniture. Serving Garden City and the Treasure Valley.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Patio & Outdoor Furniture Removal Services in Garden City</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Need patio furniture removal in Garden City? We make it easy. You point, we haul. No heavy lifting for you.</p>
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Patio & Outdoor Furniture Removal in Garden City?</h3>
