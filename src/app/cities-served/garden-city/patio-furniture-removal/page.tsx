...
export const metadata: Metadata = {
  ...
  description: 'Outdoor furniture removal including patio sets, grills, and yard furniture. in Garden City, Idaho. Same-day service. Licensed & insured. Call (208) 505-9352.',
