...
export const metadata: Metadata = {
  title: 'Table & Dining Furniture Removal Garden City ID | Top Shelf Furniture Removal',
  description: 'Dining tables, chairs, and kitchen furniture removal. Any size, any condition. in Garden City, Idaho. Same-day service. Licensed & insured. Call (208) 943-5231.',
  keywords: ['table-removal Garden City', 'furniture removal Garden City', 'junk removal Garden City'],
  alternates: {
    canonical: 'https://boise-furniture-removal.com/cities-served/garden-city/table-removal',
  },
}
...
export default function GardenCityTableRemovalPage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/table-removal.webp"
          alt="Table & Dining Furniture Removal in Garden City, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Table & Dining Furniture Removal in Garden City</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Dining tables, chairs, and kitchen furniture removal. Any size, any condition. Serving Garden City and the Treasure Valley.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Table & Dining Furniture Removal Services in Garden City</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Need table removal in Garden City? We make it easy. You point, we haul. No heavy lifting for you.</p>
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Table & Dining Furniture Removal in Garden City?</h3>
