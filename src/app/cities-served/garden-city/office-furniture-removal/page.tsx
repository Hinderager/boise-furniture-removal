...
export const metadata: Metadata = {
  title: 'Office Furniture Removal Garden City ID | Boise Furniture Removal',
...
export default function GardenCityOfficeFurnitureRemovalPage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/office-furniture-removal.webp"
          alt="Office Furniture Removal in Garden City, Idaho"
          fill
          priority
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Office Furniture Removal Services in Garden City</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Need office furniture removal in Garden City? We make it easy. You point, we haul. No heavy lifting for you.</p>
