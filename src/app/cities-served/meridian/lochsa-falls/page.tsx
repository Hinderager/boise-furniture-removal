...
export const metadata: Metadata = {
  title: 'Furniture Removal Lochsa Falls Meridian',
  ...
  alternates: {
    canonical: 'https://boise-furniture-removal.com/cities-served/meridian/lochsa-falls',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Furniture Removal in Lochsa Falls
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Serving Lochsa Falls with professional furniture removal services.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Furniture Removal in Lochsa Falls, Meridian
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Lochsa Falls furniture removal done right. We take care of your property while removing unwanted items.</p>
                <p>
