...
export const metadata: Metadata = {
  title: 'Furniture Removal Meridian ID | Boise Furniture Removal',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              ...
              <p>Boise Furniture Removal serves Meridian and the entire Treasure Valley. We show up on time, work fast, and leave your space clean. No hidden fees, no hassle.</p>
            </div>
