...
export const metadata: Metadata = {
  ...
  description: 'Professional furniture removal services in Kuna, Idaho. Couches, mattresses, office furniture & more. Same-day service available. Call (208) 943-5231.',
