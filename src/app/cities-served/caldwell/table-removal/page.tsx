...
export const metadata: Metadata = {
  ...
  description: 'Dining tables, chairs, and kitchen furniture removal. Any size, any condition. in Caldwell, Idaho. Same-day service. Licensed & insured. Call (208) 505-9352.',
