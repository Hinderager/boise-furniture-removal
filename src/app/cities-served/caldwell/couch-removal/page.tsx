...
export const metadata: Metadata = {
  ...
  description: 'Professional couch and sofa removal services. We handle all types of couches, sectionals, and loveseats. in Caldwell, Idaho. Same-day service. Licensed & insured. Call (208) 505-9352.',
